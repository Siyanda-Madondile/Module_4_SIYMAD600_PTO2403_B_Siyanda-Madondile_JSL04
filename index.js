...
let flavor = userPreference == "" ? "Regular" : "Sugar-free";
console.log(`Your preferred monster is: ${flavor}`);
...
let reStock = cansLeft <= 5 ? "Time to restock!" : "We're stocked!";
console.log(`Stock levels: ${reStock}`);
...
console.log(`Current monster levels: ${boostHeartRate}`);
...
let drinkMonster =
  currentHour < midnight ? "Better stick to water" : "Unleash the Beast!";
console.log(`${drinkMonster}`);
